...
import { History, Dumbbell, Flame, ArrowRight } from 'lucide-react';

export default function ProgrammingLogs() {
      ...
      <section className="pt-24 pb-16 md:pt-28 md:pb-20 border-b border-primary/20">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="space-y-6">
            ...
            <p className="text-primary font-display text-2xl tracking-wider neon-glow-subtle">#UNBREAKABLEPOWER</p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="p-8 text-center border-2 border-primary/30 neon-border-subtle">
              ...
              <p className="text-muted-foreground mb-6">
                Track your workout history and monitor your progress toward your goals.
              </p>
              <Button 
                size="lg" 
