      ...
      <div className="w-full max-w-sm" style={{
        ...
        <div className="flex border-b border-white/[0.06]">
          ...
          >
            Sign In
            {mode === 'signin' && (
              <div className="absolute bottom-0 left-4 right-4 h-[2px] bg-[#FF5500] rounded-full"
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl text-sm text-white outline-none transition-all focus:ring-1 focus:ring-[#FF5500]/50"
