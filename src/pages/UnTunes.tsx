              ...
              <div>
                ...
                {artistsLoading ? (
                  ...
                  <Card className="p-8 text-center border-border bg-card/50">
                    ...
                    <p className="text-xs text-muted-foreground/60 mb-4">Join as an artist for £5/month and share your music</p>
                    <Button
                      size="sm"
                    ...
                    {GENRES.map(g => (
                      ...
                      >
                        <div
                          ...
                          style={{ background: `linear-gradient(135deg, ${g.color}40, transparent)` }}
                        />
                  ...
                  <div>
                    ...
                    {playlists.length === 0 ? (
                      <Card className="p-6 text-center border-border bg-card/50">
                        <Library className="w-8 h-8 text-muted-foreground/30 mx-auto mb-2" />
