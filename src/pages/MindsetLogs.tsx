...
import { MindsetLogsView } from '@/components/mindset/MindsetLogsView';
...
export default function MindsetLogs() {
      ...
      <div className="relative px-4 pt-6 pb-5 overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="font-display text-2xl tracking-wider text-center">
            ...
            <span className="text-foreground"> MIND LOGS</span>
          </h1>
          ...
          <div className="max-w-2xl mx-auto">
            <Card className="p-8 text-center border-2 border-primary/30 bg-card">
              ...
              <p className="text-muted-foreground mb-6">
                Track your mindset activity history and monitor your progress over time.
              </p>
              <Button
                size="lg"
