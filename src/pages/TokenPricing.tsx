...
const TOP_UPS = [
  { name: 'UNBREAKABLE', tokens: 50, price: '£2.50', color: 'hsl(var(--primary))', icon: Flame },
  { name: 'KEEP SHOWING UP', tokens: 120, price: '£5', color: 'hsl(var(--primary))', icon: Zap },
  { name: 'LIVE WITHOUT LIMITS', tokens: 250, price: '£10', color: 'hsl(var(--primary))', icon: Rocket },
];
