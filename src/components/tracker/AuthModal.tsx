    ...
    try {
      ...
      if (error) {
        ...
        try {
          ...
          if (normalizedPromo === TRIAL_OFFER_CODE || isPrivateLifetimeCode) {
            // Straight to Stripe checkout — not redeem-promo-code, which doesn't know
            // either of these codes and would just report them invalid.
            try {
