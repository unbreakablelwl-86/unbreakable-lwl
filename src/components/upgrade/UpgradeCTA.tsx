  ...
  if (variant === 'banner') {
    return (
      <motion.div
        ...
        className={`w-full bg-gradient-to-r from-primary/20 via-primary/10 to-primary/20 border border-primary/30 rounded-xl px-6 py-4 flex items-center justify-between gap-4 ${className}`}
      >
