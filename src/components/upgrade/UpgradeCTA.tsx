...
export function UpgradeCTA({ feature, description, icon: Icon, variant = 'card', className = '' }: UpgradeCTAProps) {
  ...
  if (variant === 'inline') {
    return (
      ...
      >
        <Card className="relative overflow-hidden border-2 border-primary/20 hover:border-primary/40 transition-all duration-300    border-border bg-card">
          {/* Glow effect */}
  ...
  return (
    ...
    >
      <Card className="relative overflow-hidden border-2 border-primary/30    p-8 text-center border-border bg-card">
        {/* Glow effects */}
