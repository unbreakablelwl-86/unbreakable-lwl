    ...
    <div className="space-y-6">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            {isLow && !isOut && (
                              <Badge variant="outline" className="text-[10px] font-display tracking-wider text-primary border-primary/50">
                                LOW
                              </Badge>
                            )}
                          </div>
            ...
            <div className="space-y-2">
              ...
              <AnimatePresence>
                {apiResults.map((food, index) => (
                  ...
                  >
                    <Card className="hover:border-primary/50 transition-all border-border bg-card">
                      <CardContent className="p-4">
      ...
      <Dialog open={showLogModal} onOpenChange={setShowLogModal}>
        <DialogContent>
          ...
          {selectedFood && (
            <div className="space-y-4 mt-4">
              <Card className="bg-muted/30 border-border bg-card">
                <CardContent className="p-4">
