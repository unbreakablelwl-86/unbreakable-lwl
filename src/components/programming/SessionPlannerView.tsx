          ...
          return (
            <div key={day.toISOString()} className="space-y-1">
              ...
              {planner ? (
                ...
                <Card className="p-2 border border-dashed border-border/50 min-h-[80px] flex items-center justify-center border-border bg-card">
...
function UpcomingSessionCard({
  ...
  return (
    <Card className="p-3 border border-border border-border bg-card">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
