  ...
  if (step === 'info') {
    return (
      <div className="space-y-6">
          ...
          <Card className="p-5 border-primary/30 bg-primary/5 relative overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              ...
              <div className="text-right">
                <Badge className="bg-primary text-primary-foreground font-display text-[10px] tracking-wider">
                  UNLIMITED UPLOADS
                </Badge>
              </div>
            </div>
        ...
        <Button onClick={() => setStep('form')} className="w-full h-12 gap-2 font-display tracking-wider text-sm">
      ...
      <motion.div {...fadeIn} transition={{ delay: 0.1 }} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full h-24 rounded-lg border border-border/50 bg-card/50 px-3 py-2 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-primary/30"
            maxLength={500}
          />
