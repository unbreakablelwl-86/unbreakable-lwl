...
export function TrackPickerSheet({ open, onOpenChange, onSelect, selectedTrackId }: TrackPickerSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="rounded-t-2xl border-border bg-card h-[85vh]">
        ...
        {/* Track list */}
        <div className="overflow-y-auto max-h-[calc(85vh-140px)] space-y-1 pb-4">
          {loading ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {track.genre && (
                      <p className="text-[10px] text-muted-foreground/70 mt-0.5">{track.genre}</p>
                    )}
                  </div>
