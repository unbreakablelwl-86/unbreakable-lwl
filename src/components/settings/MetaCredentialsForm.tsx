    ...
    <Card className=" border-border bg-card">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          {hasCredentials && (
            <Badge className="bg-primary/20 text-primary text-[9px] font-display">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1.5">
            <Label className="text-[10px] font-display tracking-wider text-muted-foreground flex items-center gap-1.5">
              <Facebook className="w-3 h-3 text-primary" /> PAGE ACCESS TOKEN *
            </Label>
            <Input
              type="password"
              value={pageToken}
          ...
          <div className="space-y-1.5">
            <Label className="text-[10px] font-display tracking-wider text-muted-foreground flex items-center gap-1.5">
              <Facebook className="w-3 h-3 text-primary" /> FACEBOOK PAGE ID *
            </Label>
            <Input
              value={pageId}
          ...
          <div className="space-y-1.5">
            <Label className="text-[10px] font-display tracking-wider text-muted-foreground flex items-center gap-1.5">
              <Instagram className="w-3 h-3 text-primary" /> INSTAGRAM BUSINESS ACCOUNT ID
            </Label>
            <Input
              value={igId}
