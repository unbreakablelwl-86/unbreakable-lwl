...
interface MemoryMatrixLeaderboardProps {
  scores: ScoreEntry[];
...
export const MemoryMatrixLeaderboard = ({ scores, userBest, onClose, onRefetch }: MemoryMatrixLeaderboardProps) => {
              ...
              <Card className="border-border hover:border-primary/30 transition-all p-3 bg-card">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-right">
                    ...
                    {entry.max_level > 0 && (
                      <p className="text-[10px] text-muted-foreground">LVL {entry.max_level}</p>
                    )}
                  </div>
                </div>
              </Card>
