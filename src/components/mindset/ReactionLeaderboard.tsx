...
export const ReactionLeaderboard = ({ scores, userBest, onClose, onRefetch }: ReactionLeaderboardProps) => {
              ...
              <Card className="border-border hover:border-primary/30 transition-all p-3 bg-card">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-right">
                    ...
                    {entry.best_reaction_ms > 0 && (
                      <p className="text-[10px] text-muted-foreground">{entry.best_reaction_ms}ms best</p>
                    )}
                  </div>
                </div>
              </Card>
