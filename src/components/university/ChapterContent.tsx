    ...
    <div className="space-y-8">
      ...
      {ch.description && (
        <motion.div {...fadeIn} transition={{ delay: 0.1 }}>
          <Card className="p-5 border-primary/20   relative overflow-hidden border-gray-800 bg-[#111]">
      ...
      {practicalApp && (
        <motion.div {...fadeIn} transition={{ delay: 0.4 }}>
          <Card className="p-6 border-primary/20   relative overflow-hidden border-gray-800 bg-[#111]">
