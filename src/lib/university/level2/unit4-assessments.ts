  ...
  questions: [
    {
      ...
      options: ['Measurable', 'Manageable', 'Motivational', 'Meaningful'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [      'It is only missing the Time-bound component',
    ...
    },
    {
      ...
      options: [      'Trust that motivation will naturally sustain you for 12 months',
    ...
    },
    {
      ...
      options: ['Upper-only', 'Push/Pull/Legs', 'Full-body', 'Body-part split (one muscle per day)'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['30–40 sets', '1–5 sets', '10–20 sets', '5–10 sets'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [      'The overall yearly training plan',
    ...
    },
    {
      ...
      options: [      'To allow accumulated fatigue to dissipate so the body can adapt',
    ...
    },
    {
      ...
      options: ['Every 4–6 weeks', 'Only at the end of a macrocycle', 'Every 2 weeks', 'Every week'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [      'To increase blood flow, rehearse the movement, and activate the nervous system',
    ...
    },
    {
      ...
      options: ['90–120 minutes', '45–75 minutes', '15–30 minutes', '120+ minutes'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['Social media comparisons', 'Body weight scale', 'Training log', 'Progress photographs'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: [      'Continue for another 1–2 weeks to confirm a genuine plateau, then review nutrition, sleep, and recovery before making programme changes',
    ...
    },
    {
      ...
      options: ['6 months', '2–3 consecutive weeks', '1 session', '1 week'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [      'You need to add more training volume',
    ...
    },
    {
      ...
      options: [      'Response → Reward → Cue → Craving',
    ...
    },
    {
      ...
      options: [      'Wait until you feel motivated — forcing it will create negative associations',
    ...
    },
    {
      ...
      options: [      'Go directly to the gym from work, keeping a gym bag in the car, so you never go home first',
    ...
    },
    {
      ...
      options: [      'Performing two workouts per day',
    ...
    },
    {
      ...
      options: ['20 kg', '10 kg', '1.25–2.5 kg', '5 kg'],
      correctAnswer: 2,
