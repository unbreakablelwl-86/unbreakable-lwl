...
const schemes: Record<string, CourseColorScheme> = {
  ...
  sport: {
    accent: 'yellow',
    bg: 'bg-[#FFE500]/20',
    bgGradient: 'from-[#FFE500]/30 to-[#FFD000]/20',
    border: 'border-[#FFE500]/60',
    borderActive: 'border-[#FFE500]/90',
    text: 'text-[#FFE500] drop-shadow-[0_0_10px_rgba(255,229,0,0.9)] drop-shadow-[0_0_20px_rgba(255,229,0,0.5)]',
    textMuted: 'text-[#FFE500]/80',
    iconBg: 'bg-[#FFE500]/30',
    progressBg: 'bg-[#FFE500]/35',
    progressFill: 'bg-[#FFE500] shadow-[0_0_12px_rgba(255,229,0,0.7),0_0_24px_rgba(255,229,0,0.3)]',
    glow: 'shadow-[0_0_25px_rgba(255,229,0,0.45),0_0_50px_rgba(255,229,0,0.2),0_0_80px_rgba(255,229,0,0.08)]',
    hoverBg: 'hover:bg-[#FFE500]/15',
  },
};
