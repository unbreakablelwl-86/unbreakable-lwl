...
export const level3Unit1Assessment: UnitAssessment = {
  ...
  questions: [
    // ─── CH1: Macro Periodisation ───
    {
      ...
      options: ['Higher fat, lower carbs', 'Protein only, minimal carbs and fat', 'Equal across all three', 'Higher carbs, moderate protein'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['To reduce food costs', 'To match energy and nutrient demands to training goals', 'To eliminate the need for supplements', 'To keep meals interesting'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['It is replaced by fats', 'It stays the same or increases', 'It becomes irrelevant', 'It decreases proportionally'],
      correctAnswer: 1,
    ...
    // ─── CH2: Nutrient Timing ───
    {
      ...
      options: ['A strict 30-minute post-workout period', 'A debunked myth with no basis', 'A broader 3–5 hour period around training', 'Only applies to elite athletes'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['They increase fat oxidation', 'They slow digestion', 'They top up glycogen stores for fuel', 'They reduce the need for warm-ups'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['90 minutes', 'Any duration', '45 minutes', '20 minutes'],
      correctAnswer: 0,
    ...
    // ─── CH3: Supplementation ───
    {
      ...
      options: ['Creatine monohydrate', 'BCAAs', 'CLA', 'Glutamine'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: ['Taking everything available just in case', 'Using only supplements with robust peer-reviewed research', 'Following influencer recommendations', 'Avoiding all supplements entirely'],
      correctAnswer: 1,
    ...
    // ─── CH4: Body Composition ───
    {
      ...
      options: ['Maintaining the same body weight indefinitely', 'Losing weight as fast as possible', 'Bulking followed by cutting', 'Simultaneously gaining muscle and losing fat'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['BMI calculation', 'Skinfold callipers with consistent technique', 'Visual estimation', 'DEXA scan'],
      correctAnswer: 1,
    ...
    // ─── CH5: Metabolic Adaptation ───
    {
      ...
      options: ['A reduction in energy expenditure beyond what weight loss alone predicts', 'Increased appetite after exercise', 'Your body burning more calories over time', 'Higher metabolism from eating more protein'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: ['Returning to maintenance calories for 1–2 weeks', 'Eating whatever you want for a week', 'Fasting for 48 hours', 'Doubling protein intake temporarily'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: ['Eliminating carbs entirely', 'Gradually increasing calories after a deficit phase', 'Eating meals in reverse order', 'Cutting calories as fast as possible'],
      correctAnswer: 1,
    ...
    // ─── CH6: Calorie Cycling ───
    {
      ...
      options: ['A cheat day with no limits', 'Skipping meals to save calories', 'Doubling fat intake for hormonal support', 'A planned higher-calorie day emphasising carbohydrates'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['Only training once per week', 'Already at maintenance with no goals', 'Complete beginners with no training history', 'In a prolonged calorie deficit'],
      correctAnswer: 3,
    ...
    // ─── CH7: Gut Health ───
    {
      ...
      options: ['High protein intake', 'Low carbohydrate dieting', 'High fibre intake from varied plant sources', 'Frequent use of antibiotics'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Allergies only affect children', 'Intolerances are always more severe', 'Intolerances involve digestive discomfort, not immune-mediated reactions', 'They are the same thing'],
      correctAnswer: 2,
    ...
    // ─── CH8: Goal-Specific Nutrition ───
    {
      ...
      options: ['1000+ kcal', '500–1000 kcal', '100–200 kcal', '200–500 kcal'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['Fat', 'Protein', 'Fibre', 'Carbohydrates'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: [      'Cut calories further to push through the plateau',
