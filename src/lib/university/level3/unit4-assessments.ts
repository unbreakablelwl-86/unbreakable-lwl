...
export const level3Unit4Assessment: UnitAssessment = {
  ...
  questions: [
    // ─── CH1: Adherence Psychology ───
    {
      ...
      options: ['They have too much free time', 'The programme is too short', 'They are too strong', 'It does not fit their lifestyle, preferences, or identity'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['Social media likes', 'Fear of punishment', 'Internal satisfaction, enjoyment, and personal meaning', 'External rewards like money'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Perfection', 'Autonomy', 'Relatedness', 'Competence'],
      correctAnswer: 0,
    ...
    // ─── CH2: Habit Formation ───
    {
      ...
      options: ['Start, middle, end', 'Think, feel, act', 'Goal, plan, execute', 'Cue, routine, reward'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['Doing all your habits at once', 'Breaking all habits simultaneously', 'Only forming habits on weekends', 'Linking a new behaviour to an existing established habit'],
      correctAnswer: 3,
    ...
    // ─── CH3: Stress & Nervous System ───
    {
      ...
      options: ['Higher testosterone levels', 'Better immune function', 'Increased fat storage, impaired recovery, and disrupted sleep', 'Improved muscle growth'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['Increasing heart rate during exercise', 'Rest, digestion, and recovery', 'Fight-or-flight responses', 'Producing adrenaline'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['Autonomic nervous system balance and recovery readiness', 'How many calories you burn', 'Blood oxygen levels', 'Maximum strength'],
      correctAnswer: 0,
    ...
    // ─── CH4: Sleep ───
    {
      ...
      options: ['4–5 hours', '5–6 hours', '10+ hours', '7–9 hours'],
      correctAnswer: 3,
    ...
    // ─── CH5: Managing Training Around Life ───
    {
      ...
      options: ['Life disruptions reduce your available training time', 'You are a competitive powerlifter peaking for a meet', 'You have unlimited time to train', 'You want to overtrain'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: ['Avoid training for another month', 'Start at a reduced volume and intensity, then build back gradually', 'Jump straight back to where you left off', 'Double your training to make up for lost time'],
      correctAnswer: 1,
    ...
    // ─── CH6: Mental Frameworks ───
    {
      ...
      options: ['Who you want to become', 'What you want to achieve', 'What others think of you', 'How much money you earn'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: ['Talent is fixed and cannot be changed', 'Only genetics determine success', 'Failure should be avoided at all costs', 'Abilities can be developed through effort, strategy, and learning'],
      correctAnswer: 3,
    ...
    // ─── CH7: Social Influence ───
    {
      ...
      options: ['Discovering new supplements', 'Unrealistic expectations leading to discouragement and programme-hopping', 'Finding training partners', 'Learning new exercises'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['Judge you harshly for missing sessions', 'Only communicate via social media', 'Provide consistent, supportive check-ins aligned with your goals', 'Train the exact same programme as you'],
      correctAnswer: 2,
    ...
    // ─── CH8: Long-Term Sustainability ───
    {
      ...
      options: ['Aim for consistent good decisions 80% of the time rather than demanding perfection', '80% of results come from supplements', 'Only 20% of exercises matter', 'Train 80% of the time and eat badly 20%'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [      'Push through — the fatigue will pass',
    ...
    },
    {
      ...
      options: [      'Give up structured training entirely',
