...
export const level3Unit3Assessment: UnitAssessment = {
  ...
  questions: [
    // ─── CH1: Periodisation Models ───
    {
      ...
      options: ['Training the same way every session', 'Only using bodyweight exercises', 'Randomly changing variables each week', 'Gradually increasing intensity while decreasing volume over a training block'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['It requires daily maximal effort', 'It varies rep ranges and intensity within the same week', 'It never changes intensity', 'It only works for beginners'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['Recovery phases only', 'Microcycles', 'Mesocycles with a singular dominant quality', 'Warm-up blocks'],
      correctAnswer: 2,
    ...
    // ─── CH2: Exercise Selection ───
    {
      ...
      options: ['The ideal rest period between sets', 'How many calories an exercise burns', 'Whether an exercise is safe', 'How much muscle stimulus an exercise provides relative to the systemic fatigue it creates'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['Early in a session when fresh', 'At the end of a session when fatigued', 'Exclusively in warm-ups', 'Only on rest days'],
      correctAnswer: 0,
    ...
    // ─── CH3: Training Splits ───
    {
      ...
      options: ['Once', 'Four times', 'Three times', 'Twice (over 6 sessions)'],
      correctAnswer: 3,
    ...
    // ─── CH4: Auto-Regulation ───
    {
      ...
      options: ['A warm-up intensity', '3 reps in reserve', '1 rep in reserve', 'Maximum effort, no reps left'],
      correctAnswer: 2,
    ...
    },
    {
      ...
      options: ['It eliminates the need for progressive overload', 'It requires no thinking', 'It accounts for daily readiness and fatigue fluctuations', 'It always results in heavier loads'],
      correctAnswer: 2,
    ...
    // ─── CH5: Weak Point Training ───
    {
      ...
      options: ['Using machines exclusively', 'Ignoring it and focusing on strengths', 'Adding 10 sets immediately', 'Identifying the weakness through assessment, then prioritising it in programming'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['Always training it last', 'Only training it once per month', 'Training the weak muscle group first in a session when neural drive is highest', 'Replacing all other exercises'],
      correctAnswer: 2,
    ...
    // ─── CH6: Peaking & Tapering ───
    {
      ...
      options: ['Maintaining or slightly increasing intensity while reducing volume', 'Complete rest for two weeks', 'Switching to cardio-only training', 'Dramatically increasing volume'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: ['Deload weeks', 'Competitions, tests, or milestone performances', 'Beginners in their first month', 'Everyday gym sessions'],
      correctAnswer: 1,
    ...
    // ─── CH7: Training Age ───
    {
      ...
      options: ['The person is 2 years old', 'They need a personal trainer', 'They can only train twice per week', 'They have been training consistently for approximately 2 years'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['More volume, more variation, and more sophisticated periodisation', 'Only bodyweight training', 'No changes — the same programme works forever', 'Less volume and simpler programming'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: [      'Switching to a full-body programme with no bench pressing',
    ...
    },
    {
      ...
      options: [      'Prioritise back by training it first in the session and adding 2–3 extra weekly sets while slightly reducing shoulder volume',
