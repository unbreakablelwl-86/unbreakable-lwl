 ...
 *
 * University starts at Level 2 — there is no Level 1 tier or content.
 * All courses (L2, L3, L4): 50 tokens each
 * Sport-specific courses: 50 tokens each
 * Topic bundles (L2+L3+L4): 90 tokens (save 60)
 * Mega bundle (all courses): 225 tokens (save 225)
 *
...
export const BUNDLE_PRICES: Record<string, CoursePriceInfo & { courses: string[], savings: number, coinSavings: number }> = {
  power: {
    ...
    name: 'Power Bundle (L2–L4)', price: 36, coinCost: 90, type: 'bundle',
    courses: ['gym_l2', 'gym_l3', 'gym_l4'], savings: 24, coinSavings: 60,
  },
  fuel: {
    product_id: 'prod_UZYyfrSSQ8uduI', price_id: 'price_1TaPqQD5KOEmeWH2eYRVS2Yd',
    name: 'Fuel Bundle (L2–L4)', price: 36, coinCost: 90, type: 'bundle',
    courses: ['nutrition_l2', 'nutrition_l3', 'nutrition_l4'], savings: 24, coinSavings: 60,
  },
  mindset: {
    product_id: 'prod_UZYyi9FHKlN7R2', price_id: 'price_1TaPqQD5KOEmeWH2vNGarseX',
    name: 'Mindset Bundle (L2–L4)', price: 36, coinCost: 90, type: 'bundle',
    courses: ['mindset_l2', 'mindset_l3', 'mindset_l4'], savings: 24, coinSavings: 60,
  },
  all: {
    product_id: 'prod_UZYy62q7EPCaY7', price_id: 'price_1TaPqQD5KOEmeWH29Dy4Q3kN',
    name: 'Mega Bundle (All Courses)', price: 90, coinCost: 225, type: 'bundle',
    courses: ['gym_l2', 'gym_l3', 'gym_l4', 'nutrition_l2', 'nutrition_l3', 'nutrition_l4', 'mindset_l2', 'mindset_l3', 'mindset_l4'],
    savings: 90, coinSavings: 225,
  },
};
